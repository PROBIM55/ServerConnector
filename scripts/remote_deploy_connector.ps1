# =============================================================================
# DEPRECATED 2026-05-08 — НЕ ИСПОЛЬЗОВАТЬ.
#
# Этот скрипт относится к старой архитектуре деплоя:
#   - копировал код из C:\Users\opwork_admin\connector\server (вручную залитый)
#     в C:\Connector\server, удаляя его перед этим целиком
#   - вместе с кодом мог снести connector.db, если БД лежала там же
#
# Заменён автоматизированным CI/CD:
#   .github/workflows/deploy-connector-server.yml
#   scripts/server_deploy_step.ps1
# которые делают git pull в C:\Connector\src + миграции + рестарт без потери
# runtime-данных в C:\Connector\runtime\.
#
# Файл оставлен в истории; **запускать его НЕ нужно** — он сломает текущую
# раскладку сервера. Для удаления через отдельный архивный коммит, когда
# никто не сослался на него больше года.
# =============================================================================
