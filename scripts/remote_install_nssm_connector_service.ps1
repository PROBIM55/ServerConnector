# =============================================================================
# DEPRECATED 2026-05-08 — экспериментальная попытка использовать NSSM для
# запуска Connector как Windows Service. Прод сейчас на Scheduled Task
# `ConnectorApi`. Не использовать.
# =============================================================================
